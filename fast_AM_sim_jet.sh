#sh ./fast_AM_sim_jet.sh sf1_nz8_L5x2 &> /dev/null &
cd ..
...
roads_file="$inDir/roads_$EventType${PU}_Pt${Pt1}to${Pt2}GeV_${1}.root"
...
echo `date`
echo
amsim -R -i SLHCL1TrackTriggerSimulations/Configuration/input/input_GluonGluonGun_PartonPt${Pt1}to${Pt2}GeV_Oldtt27_flat_pythia6_$PU.txt \
-o $roads_file \
-b $pattern_file \
-n $NTotEv --maxMisses 1 -v 2 -s $SSConfig --maxPatterns $NBankPattern &> log/roads_$EventType${PU}_Pt${Pt1}to${Pt2}GeV_${1}.log
